...
implements ArgumentType<TestFunction> {
    ...
    public TestFunction parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        MutableComponent mutableComponent = Component.literal("No such test: " + string);
        throw new CommandSyntaxException((CommandExceptionType)new SimpleCommandExceptionType((Message)mutableComponent), (Message)mutableComponent);
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> commandContext, SuggestionsBuilder suggestionsBuilder) {
        return TestFunctionArgument.suggestTestFunction(commandContext, suggestionsBuilder);
    }
