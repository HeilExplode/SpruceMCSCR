...
public interface PlaceRecipe<T> {
    default public void placeRecipe(int n, int n2, int n3, RecipeHolder<?> recipeHolder, Iterator<T> iterator, int n4) {
        int n5 = n;
        int n6 = n2;
        ...
        block0: for (int i = 0; i < n2; ++i) {
            ...
            for (int j = 0; j < n; ++j) {
                ...
                if (bl2) {
                    this.addItemToSlot(iterator.next(), n7, n4, j, i);
                } else if (n9 == j) {
                    n7 += n - j;
                    continue block0;
                }
    ...
    public void addItemToSlot(T var1, int var2, int var3, int var4, int var5);
}
