    ...
    public static ProfilerFiller tee(final ProfilerFiller profilerFiller, final ProfilerFiller profilerFiller2) {
        ...
        return new ProfilerFiller(){
            ...
            public void incrementCounter(String string, int n) {
                profilerFiller.incrementCounter(string, n);
                profilerFiller2.incrementCounter(string, n);
            }

            @Override
            public void incrementCounter(Supplier<String> supplier, int n) {
                profilerFiller.incrementCounter(supplier, n);
                profilerFiller2.incrementCounter(supplier, n);
            }
        };
    }
}
