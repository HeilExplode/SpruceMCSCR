...
public class FastColor {
    ...
    public static class ARGB32 {
        ...
        public static int lerp(float f, int n, int n2) {
            int n3 = Mth.lerpInt(f, ARGB32.alpha(n), ARGB32.alpha(n2));
            int n4 = Mth.lerpInt(f, ARGB32.red(n), ARGB32.red(n2));
            int n5 = Mth.lerpInt(f, ARGB32.green(n), ARGB32.green(n2));
            int n6 = Mth.lerpInt(f, ARGB32.blue(n), ARGB32.blue(n2));
