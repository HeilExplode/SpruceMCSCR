                    ...
                    switch ((Integer)entry.getKey()) {
                        ...
                        case 25: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n2, NOTE_BLOCK_MAP.getOrDefault(object2, NOTE_BLOCK_MAP.get("false0")));
                            }
                            continue block14;
                        }
                        case 26: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                if (dynamic2 == null || (n3 = dynamic2.get("color").asInt(0)) == 14 || n3 < 0 || n3 >= 16 || !BED_BLOCK_MAP.containsKey(object = ChunkPalettedStorageFix.getProperty(object2, "facing") + ChunkPalettedStorageFix.getProperty(object2, "occupied") + ChunkPalettedStorageFix.getProperty(object2, "part") + n3)) continue;
                        ...
                        case 177: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                dynamic2 = this.getBlockEntity(n2 |= n);
                                object2 = this.getBlock(n2);
                                if (dynamic2 == null || (n4 = dynamic2.get("Base").asInt(0)) == 15 || n4 < 0 || n4 >= 16 || !BANNER_BLOCK_MAP.containsKey(object = ChunkPalettedStorageFix.getProperty(object2, (Integer)entry.getKey() == 176 ? "rotation" : "facing") + "_" + n4)) continue;
                        ...
                        case 140: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n2, FLOWER_POT_MAP.getOrDefault(object2, FLOWER_POT_MAP.get("minecraft:air0")));
                            }
                            continue block14;
                        }
                        case 144: {
                        ...
                        case 197: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n5, DOOR_MAP.get(string + string2 + "upper" + string4 + string3 + string5));
                            }
                            continue block14;
                        }
                        case 175: {
