...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer((DataFix)new EntityEquipmentToArmorAndHandFix(schema, true));
        Schema schema2 = dataFixerBuilder.addSchema(101, SAME);
        dataFixerBuilder.addFixer((DataFix)new BlockEntitySignTextStrictJsonFix(schema2, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new ItemWrittenBookPagesStrictJsonFix(schema15, true));
        ...
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema42, "RemoveNoteBlockFlowerPotFix", References.BLOCK_ENTITY));
        ...
        dataFixerBuilder.addFixer((DataFix)new EntityCustomNameToComponentFix(schema46, false));
        dataFixerBuilder.addFixer((DataFix)new ItemCustomNameToComponentFix(schema46, false));
        dataFixerBuilder.addFixer((DataFix)new BlockEntityCustomNameToComponentFix(schema46, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new NamedEntityFix(schema58, false, "Command block block entity custom name fix", References.BLOCK_ENTITY, "minecraft:command_block"){
        ...
        dataFixerBuilder.addFixer((DataFix)new NamedEntityFix(schema58, false, "Command block minecart custom name fix", References.ENTITY, "minecraft:commandblock_minecart"){
        ...
        dataFixerBuilder.addFixer((DataFix)new ObjectiveDisplayNameFix(schema68, false));
        dataFixerBuilder.addFixer((DataFix)new TeamDisplayNameFix(schema68, false));
        dataFixerBuilder.addFixer((DataFix)new ObjectiveRenderTypeFix(schema68, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new ItemLoreFix(schema74, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new MapIdFix(schema84, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new LevelLegacyWorldGenSettingsFix(schema119));
        ...
        dataFixerBuilder.addFixer((DataFix)new NamespacedTypeRenameFix(schema122, "Nether biome rename", References.BIOME, DataFixers.createRenamer("minecraft:nether", "minecraft:nether_wastes")));
        Schema schema123 = dataFixerBuilder.addSchema(2553, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new NamespacedTypeRenameFix(schema123, "Biomes fix", References.BIOME, DataFixers.createRenamer(BiomeFix.BIOMES)));
        ...
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema126, "Added Goat", References.ENTITY));
        Schema schema127 = dataFixerBuilder.addSchema(2679, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new CauldronRenameFix(schema127, false));
        ...
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema128, "Renamed grass path block to dirt path", DataFixers.createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        Schema schema129 = dataFixerBuilder.addSchema(2684, V2684::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema129, "Added Sculk Sensor", References.BLOCK_ENTITY));
        Schema schema130 = dataFixerBuilder.addSchema(2686, V2686::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema130, "Added Axolotl", References.ENTITY));
        Schema schema131 = dataFixerBuilder.addSchema(2688, V2688::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema131, "Added Glow Squid", References.ENTITY));
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema131, "Added Glow Item Frame", References.ENTITY));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema132, "Renamed copper block items to new oxidized terms", DataFixers.createRenamer((Map<String, String>)immutableMap)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema132, "Renamed copper blocks to new oxidized terms", DataFixers.createRenamer((Map<String, String>)immutableMap)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema133, "Rename copper item suffixes", DataFixers.createRenamer((Map<String, String>)immutableMap2)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema133, "Rename copper blocks suffixes", DataFixers.createRenamer((Map<String, String>)immutableMap2)));
        Schema schema134 = dataFixerBuilder.addSchema(2693, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema134, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema135, "Renamed grimstone block items to deepslate", DataFixers.createRenamer((Map<String, String>)immutableMap3)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema135, "Renamed grimstone blocks to deepslate", DataFixers.createRenamer((Map<String, String>)immutableMap3)));
        Schema schema136 = dataFixerBuilder.addSchema(2700, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema136, "Renamed cave vines blocks", DataFixers.createRenamer((Map<String, String>)ImmutableMap.of((Object)"minecraft:cave_vines_head", (Object)"minecraft:cave_vines", (Object)"minecraft:cave_vines_body", (Object)"minecraft:cave_vines_plant"))));
        Schema schema137 = dataFixerBuilder.addSchema(2701, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new SavedDataFeaturePoolElementFix(schema137));
        Schema schema138 = dataFixerBuilder.addSchema(2702, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AbstractArrowPickupFix(schema138));
        Schema schema139 = dataFixerBuilder.addSchema(2704, V2704::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema139, "Added Goat", References.ENTITY));
        Schema schema140 = dataFixerBuilder.addSchema(2707, V2707::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema140, "Added Marker", References.ENTITY));
        dataFixerBuilder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema140, References.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
        Schema schema141 = dataFixerBuilder.addSchema(2710, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new StatsRenameFix(schema141, "Renamed play_one_minute stat to play_time", (Map<String, String>)ImmutableMap.of((Object)"minecraft:play_one_minute", (Object)"minecraft:play_time")));
        Schema schema142 = dataFixerBuilder.addSchema(2717, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema142, "Rename azalea_leaves_flowers", DataFixers.createRenamer((Map<String, String>)ImmutableMap.of((Object)"minecraft:azalea_leaves_flowers", (Object)"minecraft:flowering_azalea_leaves"))));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema142, "Rename azalea_leaves_flowers items", DataFixers.createRenamer((Map<String, String>)ImmutableMap.of((Object)"minecraft:azalea_leaves_flowers", (Object)"minecraft:flowering_azalea_leaves"))));
        Schema schema143 = dataFixerBuilder.addSchema(2825, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AddFlagIfNotPresentFix(schema143, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
        Schema schema144 = dataFixerBuilder.addSchema(2831, V2831::new);
        dataFixerBuilder.addFixer((DataFix)new SpawnerDataFix(schema144));
        Schema schema145 = dataFixerBuilder.addSchema(2832, V2832::new);
        dataFixerBuilder.addFixer((DataFix)new WorldGenSettingsHeightAndBiomeFix(schema145));
        dataFixerBuilder.addFixer((DataFix)new ChunkHeightAndBiomeFix(schema145));
        Schema schema146 = dataFixerBuilder.addSchema(2833, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new WorldGenSettingsDisallowOldCustomWorldsFix(schema146));
        Schema schema147 = dataFixerBuilder.addSchema(2838, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new NamespacedTypeRenameFix(schema147, "Caves and Cliffs biome renames", References.BIOME, DataFixers.createRenamer(CavesAndCliffsRenames.RENAMES)));
        Schema schema148 = dataFixerBuilder.addSchema(2841, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ChunkProtoTickListFix(schema148));
        Schema schema149 = dataFixerBuilder.addSchema(2842, V2842::new);
        dataFixerBuilder.addFixer((DataFix)new ChunkRenamesFix(schema149));
        Schema schema150 = dataFixerBuilder.addSchema(2843, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new OverreachingTickFix(schema150));
        dataFixerBuilder.addFixer((DataFix)new NamespacedTypeRenameFix(schema150, "Remove Deep Warm Ocean", References.BIOME, DataFixers.createRenamer("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
        ...
        dataFixerBuilder.addFixer((DataFix)new CriteriaRenameFix(schema162, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> (String)immutableMap4.getOrDefault(string, string)));
        Schema schema163 = dataFixerBuilder.addSchema(3087, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntityVariantFix(schema163, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer((DataFix)new EntityPaintingFieldsRenameFix(schema164));
        Schema schema165 = dataFixerBuilder.addSchema(3093, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntityGoatMissingStateFix(schema165));
        Schema schema166 = dataFixerBuilder.addSchema(3094, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new GoatHornIdFix(schema166));
        Schema schema167 = dataFixerBuilder.addSchema(3097, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new FilteredBooksFix(schema167));
        dataFixerBuilder.addFixer((DataFix)new FilteredSignsFix(schema167));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        dataFixerBuilder.addFixer((DataFix)new VariantRenameFix(schema167, "Rename british shorthair", References.ENTITY, "minecraft:cat", map));
        dataFixerBuilder.addFixer((DataFix)new CriteriaRenameFix(schema167, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer((DataFix)new PoiTypeRemoveFix(schema167, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        Schema schema168 = dataFixerBuilder.addSchema(3108, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlendingDataRemoveFromNetherEndFix(schema168));
        Schema schema169 = dataFixerBuilder.addSchema(3201, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new OptionsProgrammerArtFix(schema169));
        Schema schema170 = dataFixerBuilder.addSchema(3202, V3202::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema170, "Added Hanging Sign", References.BLOCK_ENTITY));
        Schema schema171 = dataFixerBuilder.addSchema(3203, V3203::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema171, "Added Camel", References.ENTITY));
        Schema schema172 = dataFixerBuilder.addSchema(3204, V3204::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema172, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
        Schema schema173 = dataFixerBuilder.addSchema(3209, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ItemStackSpawnEggFix(schema173, false, "minecraft:pig_spawn_egg"));
        Schema schema174 = dataFixerBuilder.addSchema(3214, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new OptionsAmbientOcclusionFix(schema174));
        Schema schema175 = dataFixerBuilder.addSchema(3319, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new OptionsAccessibilityOnboardFix(schema175));
        Schema schema176 = dataFixerBuilder.addSchema(3322, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EffectDurationFix(schema176));
        Schema schema177 = dataFixerBuilder.addSchema(3325, V3325::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema177, "Added displays", References.ENTITY));
        Schema schema178 = dataFixerBuilder.addSchema(3326, V3326::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema178, "Added Sniffer", References.ENTITY));
        Schema schema179 = dataFixerBuilder.addSchema(3327, V3327::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema179, "Archaeology", References.BLOCK_ENTITY));
        Schema schema180 = dataFixerBuilder.addSchema(3328, V3328::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema180, "Added interaction", References.ENTITY));
        Schema schema181 = dataFixerBuilder.addSchema(3438, V3438::new);
        dataFixerBuilder.addFixer(BlockEntityRenameFix.create(schema181, "Rename Suspicious Sand to Brushable Block", DataFixers.createRenamer("minecraft:suspicious_sand", "minecraft:brushable_block")));
        dataFixerBuilder.addFixer((DataFix)new EntityBrushableBlockFieldsRenameFix(schema181));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema181, "Pottery shard renaming", DataFixers.createRenamer((Map<String, String>)ImmutableMap.of((Object)"minecraft:pottery_shard_archer", (Object)"minecraft:archer_pottery_shard", (Object)"minecraft:pottery_shard_prize", (Object)"minecraft:prize_pottery_shard", (Object)"minecraft:pottery_shard_arms_up", (Object)"minecraft:arms_up_pottery_shard", (Object)"minecraft:pottery_shard_skull", (Object)"minecraft:skull_pottery_shard"))));
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema181, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
        Schema schema182 = dataFixerBuilder.addSchema(3439, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlockEntitySignDoubleSidedEditableTextFix(schema182, "Updated sign text format for Signs", "minecraft:sign"));
        dataFixerBuilder.addFixer((DataFix)new BlockEntitySignDoubleSidedEditableTextFix(schema182, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
        Schema schema183 = dataFixerBuilder.addSchema(3440, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new NamespacedTypeRenameFix(schema183, "Replace experimental 1.20 overworld", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, DataFixers.createRenamer("minecraft:overworld_update_1_20", "minecraft:overworld")));
        dataFixerBuilder.addFixer((DataFix)new FeatureFlagRemoveFix(schema183, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        Schema schema184 = dataFixerBuilder.addSchema(3441, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlendingDataFix(schema184));
        Schema schema185 = dataFixerBuilder.addSchema(3447, SAME_NAMESPACED);
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema185, "Pottery shard item renaming to Pottery sherd", DataFixers.createRenamer(Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), string -> string.replace("_pottery_shard", "_pottery_sherd"))))));
        Schema schema186 = dataFixerBuilder.addSchema(3448, V3448::new);
        dataFixerBuilder.addFixer((DataFix)new DecoratedPotFieldRenameFix(schema186));
        Schema schema187 = dataFixerBuilder.addSchema(3450, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new RemapChunkStatusFix(schema187, "Remove liquid_carvers and heightmap chunk statuses", DataFixers.createRenamer(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        Schema schema188 = dataFixerBuilder.addSchema(3451, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ChunkDeleteLightFix(schema188));
        Schema schema189 = dataFixerBuilder.addSchema(3459, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new LegacyDragonFightFix(schema189));
        Schema schema190 = dataFixerBuilder.addSchema(3564, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new DropInvalidSignDataFix(schema190, "Drop invalid sign datafix data", "minecraft:sign"));
        dataFixerBuilder.addFixer((DataFix)new DropInvalidSignDataFix(schema190, "Drop invalid hanging sign datafix data", "minecraft:hanging_sign"));
        Schema schema191 = dataFixerBuilder.addSchema(3565, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new RandomSequenceSettingsFix(schema191));
        Schema schema192 = dataFixerBuilder.addSchema(3566, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ScoreboardDisplaySlotFix(schema192));
        Schema schema193 = dataFixerBuilder.addSchema(3568, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new MobEffectIdFix(schema193));
        Schema schema194 = dataFixerBuilder.addSchema(3682, V3682::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema194, "Added Crafter", References.BLOCK_ENTITY));
        Schema schema195 = dataFixerBuilder.addSchema(3683, V3683::new);
        dataFixerBuilder.addFixer((DataFix)new PrimedTntBlockStateFixer(schema195));
        Schema schema196 = dataFixerBuilder.addSchema(3685, V3685::new);
        dataFixerBuilder.addFixer((DataFix)new FixProjectileStoredItem(schema196));
        Schema schema197 = dataFixerBuilder.addSchema(3689, V3689::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema197, "Added Breeze", References.ENTITY));
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema197, "Added Trial Spawner", References.BLOCK_ENTITY));
        ...
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema199, "Added Armadillo", References.ENTITY));
        ...
        dataFixerBuilder.addFixer((DataFix)new RenameEnchantmentsFix(schema201, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
        Schema schema202 = dataFixerBuilder.addSchema(3807, V3807::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema202, "Added Vault", References.BLOCK_ENTITY));
        Schema schema203 = dataFixerBuilder.addSchema(3807, 1, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new MapBannerBlockPosFormatFix(schema203));
        Schema schema204 = dataFixerBuilder.addSchema(3808, V3808::new);
        dataFixerBuilder.addFixer((DataFix)new HorseBodyArmorItemFix(schema204, "minecraft:horse", "ArmorItem", true));
        Schema schema205 = dataFixerBuilder.addSchema(3808, 1, V3808_1::new);
        dataFixerBuilder.addFixer((DataFix)new HorseBodyArmorItemFix(schema205, "minecraft:llama", "DecorItem", false));
        Schema schema206 = dataFixerBuilder.addSchema(3808, 2, V3808_2::new);
        dataFixerBuilder.addFixer((DataFix)new HorseBodyArmorItemFix(schema206, "minecraft:trader_llama", "DecorItem", false));
        Schema schema207 = dataFixerBuilder.addSchema(3809, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ChestedHorsesInventoryZeroIndexingFix(schema207));
        Schema schema208 = dataFixerBuilder.addSchema(3812, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new FixWolfHealth(schema208));
        Schema schema209 = dataFixerBuilder.addSchema(3813, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlockPosFormatAndRenamesFix(schema209));
        Schema schema210 = dataFixerBuilder.addSchema(3814, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AttributesRename(schema210, "Rename jump strength attribute", DataFixers.createRenamer("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        Schema schema211 = dataFixerBuilder.addSchema(3816, V3816::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema211, "Added Bogged", References.ENTITY));
        Schema schema212 = dataFixerBuilder.addSchema(3818, V3818::new);
        dataFixerBuilder.addFixer((DataFix)new BeehiveFieldRenameFix(schema212));
        dataFixerBuilder.addFixer((DataFix)new EmptyItemInHotbarFix(schema212));
        Schema schema213 = dataFixerBuilder.addSchema(3818, 1, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BannerPatternFormatFix(schema213));
        Schema schema214 = dataFixerBuilder.addSchema(3818, 2, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new TippedArrowPotionToItemFix(schema214));
        Schema schema215 = dataFixerBuilder.addSchema(3818, 3, V3818_3::new);
        dataFixerBuilder.addFixer((DataFix)new WriteAndReadFix(schema215, "Inject data component types", References.DATA_COMPONENTS));
        Schema schema216 = dataFixerBuilder.addSchema(3818, 4, V3818_4::new);
        dataFixerBuilder.addFixer((DataFix)new ParticleUnflatteningFix(schema216));
        Schema schema217 = dataFixerBuilder.addSchema(3818, 5, V3818_5::new);
        dataFixerBuilder.addFixer((DataFix)new ItemStackComponentizationFix(schema217));
        Schema schema218 = dataFixerBuilder.addSchema(3818, 6, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AreaEffectCloudPotionFix(schema218));
        Schema schema219 = dataFixerBuilder.addSchema(3820, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new PlayerHeadBlockProfileFix(schema219));
        dataFixerBuilder.addFixer((DataFix)new LodestoneCompassComponentFix(schema219));
        Schema schema220 = dataFixerBuilder.addSchema(3825, V3825::new);
        dataFixerBuilder.addFixer((DataFix)new ItemStackCustomNameToOverrideComponentFix(schema220));
        dataFixerBuilder.addFixer((DataFix)new BannerEntityCustomNameToOverrideComponentFix(schema220));
        dataFixerBuilder.addFixer((DataFix)new TrialSpawnerConfigFix(schema220));
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema220, "Added Ominous Item Spawner", References.ENTITY));
        Schema schema221 = dataFixerBuilder.addSchema(3828, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EmptyItemInVillagerTradeFix(schema221));
        Schema schema222 = dataFixerBuilder.addSchema(3833, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new RemoveEmptyItemInBrushableBlockFix(schema222));
        Schema schema223 = dataFixerBuilder.addSchema(3938, V3938::new);
        dataFixerBuilder.addFixer((DataFix)new ProjectileStoredWeaponFix(schema223));
        Schema schema224 = dataFixerBuilder.addSchema(3939, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new FeatureFlagRemoveFix(schema224, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
        Schema schema225 = dataFixerBuilder.addSchema(3943, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new OptionsMenuBlurrinessFix(schema225));
        Schema schema226 = dataFixerBuilder.addSchema(3945, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AttributeModifierIdFix(schema226));
        dataFixerBuilder.addFixer((DataFix)new JukeboxTicksSinceSongStartedFix(schema226));
    }
