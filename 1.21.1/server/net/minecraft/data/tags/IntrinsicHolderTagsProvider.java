...
extends TagsProvider<T> {
    ...
    extends TagsProvider.TagAppender<T> {
        ...
        public final IntrinsicTagAppender<T> add(T t) {
            ((TagsProvider.TagAppender)this).add(this.keyExtractor.apply(t));
            return this;
        }

        @SafeVarargs
        public final IntrinsicTagAppender<T> add(T ... TArray) {
            Stream.of(TArray).map(this.keyExtractor).forEach(this::add);
            return this;
        }
