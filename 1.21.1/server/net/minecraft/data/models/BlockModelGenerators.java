...
public class BlockModelGenerators {
    ...
    public static final List<Pair<BooleanProperty, Function<ResourceLocation, Variant>>> MULTIFACE_GENERATOR = List.of(Pair.of((Object)BlockStateProperties.NORTH, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation)), Pair.of((Object)BlockStateProperties.EAST, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)), Pair.of((Object)BlockStateProperties.SOUTH, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180).with(VariantProperties.UV_LOCK, true)), Pair.of((Object)BlockStateProperties.WEST, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true)), Pair.of((Object)BlockStateProperties.UP, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.X_ROT, VariantProperties.Rotation.R270).with(VariantProperties.UV_LOCK, true)), Pair.of((Object)BlockStateProperties.DOWN, resourceLocation -> Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.UV_LOCK, true)));
    ...
    private void createBrushableBlock(Block block) {
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.DUSTED).generate(n -> {
            String string = "_" + n;
            ResourceLocation resourceLocation = TextureMapping.getBlockTexture(block, string);
            return Variant.variant().with(VariantProperties.MODEL, ModelTemplates.CUBE_ALL.createWithSuffix(block, string, new TextureMapping().put(TextureSlot.ALL, resourceLocation), this.modelOutput));
        })));
    ...
    private void copyDoorModel(Block block, Block block2) {
        ...
        this.blockStateOutput.accept(BlockModelGenerators.createDoor(block2, resourceLocation, resourceLocation2, resourceLocation3, resourceLocation4, resourceLocation5, resourceLocation6, resourceLocation7, resourceLocation8));
    }
    ...
    private void copyTrapdoorModel(Block block, Block block2) {
        ...
        this.delegateItemModel(block2, ModelLocationUtils.getModelLocation(block.asItem()));
        this.blockStateOutput.accept(BlockModelGenerators.createTrapdoor(block2, resourceLocation, resourceLocation2, resourceLocation3));
    }
    ...
    private void createCrossBlock(Block block, TintState tintState, Property<Integer> property, int ... nArray) {
        ...
        PropertyDispatch propertyDispatch = PropertyDispatch.property(property).generate(n -> {
    ...
    private void createPitcherCrop() {
        ...
        this.createSimpleFlatItemModel(block.asItem());
        PropertyDispatch propertyDispatch = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF).generate((n, doubleBlockHalf) -> switch (doubleBlockHalf) {
            default -> throw new MatchException(null, null);
            case DoubleBlockHalf.UPPER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_top_stage_" + n));
            case DoubleBlockHalf.LOWER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_bottom_stage_" + n));
        });
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(propertyDispatch));
    }
    ...
    private void createCropBlock(Block block, Property<Integer> property, int ... nArray) {
        ...
        PropertyDispatch propertyDispatch = PropertyDispatch.property(property).generate(arg_0 -> this.lambda$createCropBlock$15(nArray, (Int2ObjectMap)int2ObjectOpenHashMap, block, arg_0));
        this.createSimpleFlatItemModel(block.asItem());
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(propertyDispatch));
    }
    ...
    private void createPottedAzalea(Block block) {
        ResourceLocation resourceLocation = block == Blocks.POTTED_FLOWERING_AZALEA ? ModelTemplates.POTTED_FLOWERING_AZALEA.create(block, TextureMapping.pottedAzalea(block), this.modelOutput) : ModelTemplates.POTTED_AZALEA.create(block, TextureMapping.pottedAzalea(block), this.modelOutput);
        this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(block, resourceLocation));
    }
    ...
    private void createCrafterBlock() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CRAFTER).with(PropertyDispatch.property(BlockStateProperties.ORIENTATION).generate(frontAndTop -> this.applyRotation((FrontAndTop)frontAndTop, Variant.variant()))).with(PropertyDispatch.properties(BlockStateProperties.TRIGGERED, CrafterBlock.CRAFTING).select((Boolean)false, (Boolean)false, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select((Boolean)true, (Boolean)true, Variant.variant().with(VariantProperties.MODEL, resourceLocation4)).select((Boolean)true, (Boolean)false, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select((Boolean)false, (Boolean)true, Variant.variant().with(VariantProperties.MODEL, resourceLocation3))));
    }
    ...
    private BlockStateGenerator createCopperBulb(Block block, ResourceLocation resourceLocation, ResourceLocation resourceLocation2, ResourceLocation resourceLocation3, ResourceLocation resourceLocation4) {
        return MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED).generate((bl, bl2) -> {
            if (bl.booleanValue()) {
                return Variant.variant().with(VariantProperties.MODEL, bl2 != false ? resourceLocation4 : resourceLocation2);
            }
            return Variant.variant().with(VariantProperties.MODEL, bl2 != false ? resourceLocation3 : resourceLocation);
        }));
    }
    ...
    private void createTrialSpawner() {
        ...
        ResourceLocation resourceLocation3 = ModelTemplates.CUBE_BOTTOM_TOP_INNER_FACES.createWithSuffix(block, "_ejecting_reward", textureMapping3, this.modelOutput);
        ResourceLocation resourceLocation4 = ModelTemplates.CUBE_BOTTOM_TOP_INNER_FACES.createWithSuffix(block, "_inactive_ominous", textureMapping4, this.modelOutput);
        ...
        ResourceLocation resourceLocation6 = ModelTemplates.CUBE_BOTTOM_TOP_INNER_FACES.createWithSuffix(block, "_ejecting_reward_ominous", textureMapping6, this.modelOutput);
        this.delegateItemModel(block, resourceLocation);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.properties(BlockStateProperties.TRIAL_SPAWNER_STATE, BlockStateProperties.OMINOUS).generate((trialSpawnerState, bl) -> switch (trialSpawnerState) {
            default -> throw new MatchException(null, null);
            case TrialSpawnerState.INACTIVE, TrialSpawnerState.COOLDOWN -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation4 : resourceLocation);
            case TrialSpawnerState.WAITING_FOR_PLAYERS, TrialSpawnerState.ACTIVE, TrialSpawnerState.WAITING_FOR_REWARD_EJECTION -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation5 : resourceLocation2);
            case TrialSpawnerState.EJECTING_REWARD -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation6 : resourceLocation3);
        })));
    }
    ...
    private void createVault() {
        ...
        this.delegateItemModel(block, resourceLocation);
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(BlockModelGenerators.createHorizontalFacingDispatch()).with(PropertyDispatch.properties(VaultBlock.STATE, VaultBlock.OMINOUS).generate((vaultState, bl) -> switch (vaultState) {
            default -> throw new MatchException(null, null);
            case VaultState.INACTIVE -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation5 : resourceLocation);
            case VaultState.ACTIVE -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation6 : resourceLocation2);
            case VaultState.UNLOCKING -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation7 : resourceLocation3);
            case VaultState.EJECTING -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation8 : resourceLocation4);
        })));
    }
    ...
    private void createSculkSensor() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SCULK_SENSOR).with(PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE).generate(sculkSensorPhase -> Variant.variant().with(VariantProperties.MODEL, sculkSensorPhase == SculkSensorPhase.ACTIVE || sculkSensorPhase == SculkSensorPhase.COOLDOWN ? resourceLocation2 : resourceLocation))));
    }
    ...
    private void createCalibratedSculkSensor() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CALIBRATED_SCULK_SENSOR).with(PropertyDispatch.property(BlockStateProperties.SCULK_SENSOR_PHASE).generate(sculkSensorPhase -> Variant.variant().with(VariantProperties.MODEL, sculkSensorPhase == SculkSensorPhase.ACTIVE || sculkSensorPhase == SculkSensorPhase.COOLDOWN ? resourceLocation2 : resourceLocation))).with(BlockModelGenerators.createHorizontalFacingDispatch()));
    }
    ...
    private void createSnifferEgg() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SNIFFER_EGG).with(PropertyDispatch.property(SnifferEggBlock.HATCH).generate(n -> Variant.variant().with(VariantProperties.MODEL, (ResourceLocation)function.apply((Integer)n)))));
    }
    ...
    private void createSculkCatalyst() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SCULK_CATALYST).with(PropertyDispatch.property(BlockStateProperties.BLOOM).generate(bl -> Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation3 : resourceLocation2))));
    ...
    private void createChiseledBookshelf() {
        ...
        ResourceLocation resourceLocation = ModelLocationUtils.getModelLocation(block);
        MultiPartGenerator multiPartGenerator = MultiPartGenerator.multiPart(block);
        List.of(Pair.of((Object)Direction.NORTH, (Object)((Object)VariantProperties.Rotation.R0)), Pair.of((Object)Direction.EAST, (Object)((Object)VariantProperties.Rotation.R90)), Pair.of((Object)Direction.SOUTH, (Object)((Object)VariantProperties.Rotation.R180)), Pair.of((Object)Direction.WEST, (Object)((Object)VariantProperties.Rotation.R270))).forEach(pair -> {
    ...
    private void createRespawnAnchor() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.RESPAWN_ANCHOR).with(PropertyDispatch.property(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate(n -> Variant.variant().with(VariantProperties.MODEL, resourceLocationArray[n]))));
        this.delegateItemModel(Items.RESPAWN_ANCHOR, resourceLocationArray[0]);
    }
    ...
    public void run() {
        ...
        this.createCrossBlock(Blocks.TORCHFLOWER_CROP, TintState.NOT_TINTED, BlockStateProperties.AGE_1, 0, 1);
        ...
        this.createCrossBlockWithDefaultItem(Blocks.SHORT_GRASS, TintState.TINTED);
        this.createCrossBlock(Blocks.SUGAR_CANE, TintState.TINTED);
        this.createSimpleFlatItemModel(Items.SUGAR_CANE);
        this.createGrowingPlant(Blocks.KELP, Blocks.KELP_PLANT, TintState.NOT_TINTED);
    ...
    private /* synthetic */ Variant lambda$createCropBlock$15(int[] nArray, Int2ObjectMap int2ObjectMap, Block block, Integer n) {
        int n3 = nArray[n];
    ...
    class BlockEntityModelGenerator {
        ...
        public BlockEntityModelGenerator create(Block ... blockArray) {
            for (Block block : blockArray) {
        ...
        public BlockEntityModelGenerator createWithoutBlockItem(Block ... blockArray) {
            for (Block block : blockArray) {
                BlockModelGenerators.this.skipAutoItemBlock(block);
            }
            return this.create(blockArray);
        }

        public BlockEntityModelGenerator createWithCustomBlockItemModel(ModelTemplate modelTemplate, Block ... blockArray) {
            for (Block block : blockArray) {
