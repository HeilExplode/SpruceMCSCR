...
implements BlockStateGenerator {
    ...
    public static MultiVariantGenerator multiVariant(Block block, Variant ... variantArray) {
        return new MultiVariantGenerator(block, (List<Variant>)ImmutableList.copyOf((Object[])variantArray));
    }
