...
public class TreeFeatures {
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(Block block, Block block2, int n, int n2, int n3, int n4) {
        return new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(block), new StraightTrunkPlacer(n, n2, n3), BlockStateProvider.simple(block2), new BlobFoliagePlacer(ConstantInt.of(n4), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1));
    }
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
        ...
        FeatureUtils.register(bootstrapContext, CHERRY_BEES_005, Feature.TREE, TreeFeatures.cherry().decorators(List.of(beehiveDecorator4)).build());
        ...
        FeatureUtils.register(bootstrapContext, OAK_BEES_0002, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(bootstrapContext, OAK_BEES_002, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, OAK_BEES_005, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, BIRCH_BEES_005, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_0002, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehiveDecorator)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_002, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehiveDecorator3)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES_005, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehiveDecorator4)).build());
        FeatureUtils.register(bootstrapContext, FANCY_OAK_BEES, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehiveDecorator5)).build());
    }
}
