    ...
    private static Node parseNode(StringReader stringReader, boolean bl) throws CommandSyntaxException {
        return switch (stringReader.peek()) {
            case '{' -> {
                ...
                CompoundTag var2_2 = new TagParser(stringReader).readStruct();
            ...
            case '[' -> {
                ...
                if (var2_3 == '{') {
                    CompoundTag var3_4 = new TagParser(stringReader).readStruct();
                    stringReader.expect(']');
            ...
            block4: {
                block3: {
                    ...
                    for (String string : compoundTag.getAllKeys()) {
                        ...
                        if (tag2 == null || !NbtPath.isTooDeep(tag2, n + 1)) continue;
                        return true;
                    }
                    break block4;
                }
