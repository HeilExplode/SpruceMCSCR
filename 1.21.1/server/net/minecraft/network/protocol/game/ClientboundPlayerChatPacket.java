...
public record ClientboundPlayerChatPacket(UUID sender, int index, @Nullable MessageSignature signature, SignedMessageBody.Packed body, @Nullable Component unsignedContent, FilterMask filterMask, ChatType.Bound chatType) implements Packet<ClientGamePacketListener>
{
    ...
    private ClientboundPlayerChatPacket(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
        this(registryFriendlyByteBuf.readUUID(), registryFriendlyByteBuf.readVarInt(), registryFriendlyByteBuf.readNullable(MessageSignature::read), new SignedMessageBody.Packed(registryFriendlyByteBuf), FriendlyByteBuf.readNullable(registryFriendlyByteBuf, ComponentSerialization.TRUSTED_STREAM_CODEC), FilterMask.read(registryFriendlyByteBuf), (ChatType.Bound)ChatType.Bound.STREAM_CODEC.decode(registryFriendlyByteBuf));
    }
