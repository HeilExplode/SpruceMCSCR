...
implements Packet<ClientGamePacketListener> {
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundUpdateRecipesPacket> STREAM_CODEC = StreamCodec.composite(RecipeHolder.STREAM_CODEC.apply(ByteBufCodecs.list()), clientboundUpdateRecipesPacket -> clientboundUpdateRecipesPacket.recipes, ClientboundUpdateRecipesPacket::new);
