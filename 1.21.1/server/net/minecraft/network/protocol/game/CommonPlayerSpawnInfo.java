...
public record CommonPlayerSpawnInfo(Holder<DimensionType> dimensionType, ResourceKey<Level> dimension, long seed, GameType gameType, @Nullable GameType previousGameType, boolean isDebug, boolean isFlat, Optional<GlobalPos> lastDeathLocation, int portalCooldown) {
    public CommonPlayerSpawnInfo(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
        this((Holder)DimensionType.STREAM_CODEC.decode(registryFriendlyByteBuf), registryFriendlyByteBuf.readResourceKey(Registries.DIMENSION), registryFriendlyByteBuf.readLong(), GameType.byId(registryFriendlyByteBuf.readByte()), GameType.byNullableId(registryFriendlyByteBuf.readByte()), registryFriendlyByteBuf.readBoolean(), registryFriendlyByteBuf.readBoolean(), registryFriendlyByteBuf.readOptional(FriendlyByteBuf::readGlobalPos), registryFriendlyByteBuf.readVarInt());
    }
