...
extends Animal {
    ...
    public ItemStack createHorn() {
        ...
        HolderSet.Named<Instrument> named = BuiltInRegistries.INSTRUMENT.getOrCreateTag(tagKey);
        return InstrumentItem.create(Items.GOAT_HORN, named.getRandomElement(randomSource).get());
    }
