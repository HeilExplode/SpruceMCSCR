...
extends AbstractFish {
    ...
    private void ageUp() {
        ...
        if (object instanceof ServerLevel) {
            ...
            if (object != null) {
                ((Entity)object).moveTo(this.getX(), this.getY(), this.getZ(), this.getYRot(), this.getXRot());
                ((Frog)object).finalizeSpawn(serverLevel, this.level().getCurrentDifficultyAt(((Entity)object).blockPosition()), MobSpawnType.CONVERSION, null);
                ...
                ((Entity)object).fudgePositionAfterSizeChange(this.getDimensions(this.getPose()));
