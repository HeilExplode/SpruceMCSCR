...
implements VariantHolder<Holder<FrogVariant>> {
    ...
    public void addAdditionalSaveData(CompoundTag compoundTag) {
        ...
        compoundTag.putString(VARIANT_KEY, this.getVariant().unwrapKey().orElse(DEFAULT_VARIANT).location().toString());
    }

    @Override
    public void readAdditionalSaveData(CompoundTag compoundTag) {
        super.readAdditionalSaveData(compoundTag);
        Optional.ofNullable(ResourceLocation.tryParse(compoundTag.getString(VARIANT_KEY))).map(resourceLocation -> ResourceKey.create(Registries.FROG_VARIANT, resourceLocation)).flatMap(BuiltInRegistries.FROG_VARIANT::getHolder).ifPresent(this::setVariant);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance difficultyInstance, MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData) {
        ...
        if (holder.is(BiomeTags.SPAWNS_COLD_VARIANT_FROGS)) {
            this.setVariant((Holder<FrogVariant>)BuiltInRegistries.FROG_VARIANT.getHolderOrThrow(FrogVariant.COLD));
        } else if (holder.is(BiomeTags.SPAWNS_WARM_VARIANT_FROGS)) {
            this.setVariant((Holder<FrogVariant>)BuiltInRegistries.FROG_VARIANT.getHolderOrThrow(FrogVariant.WARM));
        } else {
            this.setVariant((Holder<FrogVariant>)BuiltInRegistries.FROG_VARIANT.getHolderOrThrow(DEFAULT_VARIANT));
        }
