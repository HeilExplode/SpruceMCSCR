...
extends AbstractHorse {
    ...
    public static boolean checkSkeletonHorseSpawnRules(EntityType<? extends Animal> entityType, LevelAccessor levelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
        if (MobSpawnType.isSpawner(mobSpawnType)) {
            return MobSpawnType.ignoresLightRequirements(mobSpawnType) || SkeletonHorse.isBrightEnoughToSpawn(levelAccessor, blockPos);
        }
