...
extends AbstractHorse {
    ...
    public static boolean checkZombieHorseSpawnRules(EntityType<? extends Animal> entityType, LevelAccessor levelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
        if (MobSpawnType.isSpawner(mobSpawnType)) {
            return MobSpawnType.ignoresLightRequirements(mobSpawnType) || ZombieHorse.isBrightEnoughToSpawn(levelAccessor, blockPos);
        }
