...
implements VibrationSystem {
    ...
    public void addAdditionalSaveData(CompoundTag compoundTag) {
        ...
        AngerManagement.codec(this::canTargetEntity).encodeStart(registryOps, (Object)this.angerManagement).resultOrPartial(string -> LOGGER.error("Failed to encode anger state for Warden: '{}'", string)).ifPresent(tag -> compoundTag.put("anger", (Tag)tag));
        VibrationSystem.Data.CODEC.encodeStart(registryOps, (Object)this.vibrationData).resultOrPartial(string -> LOGGER.error("Failed to encode vibration listener for Warden: '{}'", string)).ifPresent(tag -> compoundTag.put("listener", (Tag)tag));
    }
    ...
    public void readAdditionalSaveData(CompoundTag compoundTag) {
        ...
        if (compoundTag.contains("anger")) {
            AngerManagement.codec(this::canTargetEntity).parse(registryOps, (Object)compoundTag.get("anger")).resultOrPartial(string -> LOGGER.error("Failed to parse anger state for Warden: '{}'", string)).ifPresent(angerManagement -> {
                this.angerManagement = angerManagement;
            });
            this.syncClientAngerLevel();
        }
        if (compoundTag.contains("listener", 10)) {
            VibrationSystem.Data.CODEC.parse(registryOps, (Object)compoundTag.getCompound("listener")).resultOrPartial(string -> LOGGER.error("Failed to parse vibration listener for Warden: '{}'", string)).ifPresent(data -> {
