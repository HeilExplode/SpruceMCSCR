...
implements RangedAttackMob {
    ...
    public static boolean checkDrownedSpawnRules(EntityType<Drowned> entityType, ServerLevelAccessor serverLevelAccessor, MobSpawnType mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
        ...
        boolean bl2 = bl = !(serverLevelAccessor.getDifficulty() == Difficulty.PEACEFUL || !MobSpawnType.ignoresLightRequirements(mobSpawnType) && !Drowned.isDarkEnoughToSpawn(serverLevelAccessor, blockPos, randomSource) || !MobSpawnType.isSpawner(mobSpawnType) && !serverLevelAccessor.getFluidState(blockPos).is(FluidTags.WATER));
