...
extends NearestAttackableTargetGoal<T> {
    ...
    public NearestHealableRaiderTargetGoal(Raider raider, Class<T> clazz, boolean bl, @Nullable Predicate<LivingEntity> predicate) {
        super(raider, clazz, 500, bl, false, predicate);
    }
