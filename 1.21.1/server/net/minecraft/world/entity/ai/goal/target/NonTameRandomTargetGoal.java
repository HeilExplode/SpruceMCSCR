...
extends NearestAttackableTargetGoal<T> {
    ...
    public NonTameRandomTargetGoal(TamableAnimal tamableAnimal, Class<T> clazz, boolean bl, @Nullable Predicate<LivingEntity> predicate) {
        super(tamableAnimal, clazz, 10, bl, false, predicate);
