...
extends Sensor<T> {
    ...
    protected void doTick(ServerLevel serverLevel, T t) {
        AABB aABB = ((Entity)t).getBoundingBox().inflate(this.radiusXZ(), this.radiusY(), this.radiusXZ());
        ...
        brain.setMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES, new NearestVisibleLivingEntities((LivingEntity)t, list));
    }
