...
public final class EntitySelector {
    ...
    public static Predicate<Entity> pushableBy(Entity entity) {
        ...
        return NO_SPECTATORS.and(entity2 -> {
            ...
            PlayerTeam playerTeam = entity2.getTeam();
            Team.CollisionRule collisionRule3 = collisionRule2 = playerTeam == null ? Team.CollisionRule.ALWAYS : ((Team)playerTeam).getCollisionRule();
            if (collisionRule2 == Team.CollisionRule.NEVER) {
                return false;
            }
            boolean bl2 = bl = playerTeam != null && playerTeam.isAlliedTo(playerTeam);
