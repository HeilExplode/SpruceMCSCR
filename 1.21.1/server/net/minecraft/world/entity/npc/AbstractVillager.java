...
Merchant {
    ...
    public void addAdditionalSaveData(CompoundTag compoundTag) {
        ...
        if (!this.level().isClientSide && !(merchantOffers = this.getOffers()).isEmpty()) {
            compoundTag.put("Offers", (Tag)MerchantOffers.CODEC.encodeStart(this.registryAccess().createSerializationContext(NbtOps.INSTANCE), (Object)merchantOffers).getOrThrow());
        }
