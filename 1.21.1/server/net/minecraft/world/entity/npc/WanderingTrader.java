...
extends AbstractVillager {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new UseItemGoal<WanderingTrader>(this, PotionContents.createItemStack(Items.POTION, Potions.INVISIBILITY), SoundEvents.WANDERING_TRADER_DISAPPEARED, wanderingTrader -> this.level().isNight() && !wanderingTrader.isInvisible()));
    ...
    protected void updateTrades() {
        ...
        VillagerTrades.ItemListing[] itemListingArray = (VillagerTrades.ItemListing[])VillagerTrades.WANDERING_TRADER_TRADES.get(1);
        VillagerTrades.ItemListing[] itemListingArray2 = (VillagerTrades.ItemListing[])VillagerTrades.WANDERING_TRADER_TRADES.get(2);
        if (itemListingArray == null || itemListingArray2 == null) {
            return;
        }
        MerchantOffers merchantOffers = this.getOffers();
        this.addOffersFromItemListings(merchantOffers, itemListingArray, 5);
        int n = this.random.nextInt(itemListingArray2.length);
        VillagerTrades.ItemListing itemListing = itemListingArray2[n];
    ...
    public void readAdditionalSaveData(CompoundTag compoundTag) {
        ...
        NbtUtils.readBlockPos(compoundTag, "wander_target").ifPresent(blockPos -> {
