...
public class StructureManager {
    ...
    public StructureStart getStructureWithPieceAt(BlockPos blockPos, Predicate<Holder<Structure>> predicate) {
        ...
        for (StructureStart structureStart : this.startsForStructure(new ChunkPos(blockPos), (Structure structure) -> registry.getHolder(registry.getId((Structure)structure)).map(predicate::test).orElse(false))) {
