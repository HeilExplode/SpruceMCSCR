...
extends SavedData {
    ...
    public static StructureFeatureIndexSavedData load(CompoundTag compoundTag, HolderLookup.Provider provider) {
        return new StructureFeatureIndexSavedData((LongSet)new LongOpenHashSet(compoundTag.getLongArray(TAG_All_INDEXES)), (LongSet)new LongOpenHashSet(compoundTag.getLongArray(TAG_REMAINING_INDEXES)));
    }
