...
extends StructurePiece {
    ...
    public PoolElementStructurePiece(StructurePieceSerializationContext structurePieceSerializationContext, CompoundTag compoundTag) {
        ...
        this.element = (StructurePoolElement)StructurePoolElement.CODEC.parse(registryOps, (Object)compoundTag.getCompound("pool_element")).getPartialOrThrow(string -> new IllegalStateException("Invalid pool element found: " + string));
        ...
        this.liquidSettings = LiquidSettings.CODEC.parse((DynamicOps)NbtOps.INSTANCE, (Object)compoundTag.get("liquid_settings")).result().orElse(JigsawStructure.DEFAULT_LIQUID_SETTINGS);
    }
    ...
    protected void addAdditionalSaveData(StructurePieceSerializationContext structurePieceSerializationContext, CompoundTag compoundTag) {
        ...
        RegistryOps<Tag> registryOps = structurePieceSerializationContext.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        StructurePoolElement.CODEC.encodeStart(registryOps, (Object)this.element).resultOrPartial(arg_0 -> ((Logger)LOGGER).error(arg_0)).ifPresent(tag -> compoundTag.put("pool_element", (Tag)tag));
        ...
        if (this.liquidSettings != JigsawStructure.DEFAULT_LIQUID_SETTINGS) {
            compoundTag.put("liquid_settings", (Tag)LiquidSettings.CODEC.encodeStart((DynamicOps)NbtOps.INSTANCE, (Object)this.liquidSettings).getOrThrow());
        }
    }
