...
public class BuiltInLootTables {
    ...
    public static final ResourceKey<LootTable> SHEEP_WHITE = BuiltInLootTables.register("entities/sheep/white");
    public static final ResourceKey<LootTable> SHEEP_ORANGE = BuiltInLootTables.register("entities/sheep/orange");
    public static final ResourceKey<LootTable> SHEEP_MAGENTA = BuiltInLootTables.register("entities/sheep/magenta");
    public static final ResourceKey<LootTable> SHEEP_LIGHT_BLUE = BuiltInLootTables.register("entities/sheep/light_blue");
    public static final ResourceKey<LootTable> SHEEP_YELLOW = BuiltInLootTables.register("entities/sheep/yellow");
    public static final ResourceKey<LootTable> SHEEP_LIME = BuiltInLootTables.register("entities/sheep/lime");
    public static final ResourceKey<LootTable> SHEEP_PINK = BuiltInLootTables.register("entities/sheep/pink");
    public static final ResourceKey<LootTable> SHEEP_GRAY = BuiltInLootTables.register("entities/sheep/gray");
    public static final ResourceKey<LootTable> SHEEP_LIGHT_GRAY = BuiltInLootTables.register("entities/sheep/light_gray");
    public static final ResourceKey<LootTable> SHEEP_CYAN = BuiltInLootTables.register("entities/sheep/cyan");
    public static final ResourceKey<LootTable> SHEEP_PURPLE = BuiltInLootTables.register("entities/sheep/purple");
    public static final ResourceKey<LootTable> SHEEP_BLUE = BuiltInLootTables.register("entities/sheep/blue");
    public static final ResourceKey<LootTable> SHEEP_BROWN = BuiltInLootTables.register("entities/sheep/brown");
    public static final ResourceKey<LootTable> SHEEP_GREEN = BuiltInLootTables.register("entities/sheep/green");
    public static final ResourceKey<LootTable> SHEEP_RED = BuiltInLootTables.register("entities/sheep/red");
    public static final ResourceKey<LootTable> SHEEP_BLACK = BuiltInLootTables.register("entities/sheep/black");
