...
public class MapColor {
    ...
    public int calculateRGBColor(Brightness brightness) {
        ...
        int n = brightness.modifier;
        int n2 = (this.col >> 16 & 0xFF) * n / 255;
        int n3 = (this.col >> 8 & 0xFF) * n / 255;
        int n4 = (this.col & 0xFF) * n / 255;
        return 0xFF000000 | n4 << 16 | n3 << 8 | n2;
    }
    ...
    public static int getColorFromPackedId(int n) {
        int n2 = n & 0xFF;
        return MapColor.byIdUnsafe(n2 >> 2).calculateRGBColor(Brightness.byIdUnsafe(n2 & 3));
    }
