...
implements SmithingRecipe {
    ...
    public ItemStack getResultItem(HolderLookup.Provider provider) {
        ...
        Optional optional = provider.lookupOrThrow(Registries.TRIM_PATTERN).listElements().findFirst();
        ...
        if (optional.isPresent() && optional2.isPresent()) {
            itemStack.set(DataComponents.TRIM, new ArmorTrim((Holder<TrimMaterial>)optional2.get(), optional.get()));
        }
        return itemStack;
    }
