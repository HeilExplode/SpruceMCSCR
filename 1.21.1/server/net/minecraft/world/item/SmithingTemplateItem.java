...
extends Item {
    ...
    private static final Component NETHERITE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", ResourceLocation.withDefaultNamespace("netherite_upgrade"))).withStyle(TITLE_FORMAT);
    ...
    public SmithingTemplateItem(Component component, Component component2, Component component3, Component component4, Component component5, List<ResourceLocation> list, List<ResourceLocation> list2, FeatureFlag ... featureFlagArray) {
        super(new Item.Properties().requiredFeatures(featureFlagArray));
    ...
    public static SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> resourceKey, FeatureFlag ... featureFlagArray) {
        return SmithingTemplateItem.createArmorTrimTemplate(resourceKey.location(), featureFlagArray);
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation resourceLocation, FeatureFlag ... featureFlagArray) {
        return new SmithingTemplateItem(ARMOR_TRIM_APPLIES_TO, ARMOR_TRIM_INGREDIENTS, Component.translatable(Util.makeDescriptionId("trim_pattern", resourceLocation)).withStyle(TITLE_FORMAT), ARMOR_TRIM_BASE_SLOT_DESCRIPTION, ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION, SmithingTemplateItem.createTrimmableArmorIconList(), SmithingTemplateItem.createTrimmableMaterialIconList(), featureFlagArray);
    }
