...
public class CreativeModeTabs {
    ...
    public static CreativeModeTab bootstrap(Registry<CreativeModeTab> registry) {
        ...
        Registry.register(registry, FOOD_AND_DRINKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 2).title(Component.translatable("itemGroup.foodAndDrink")).icon(() -> new ItemStack(Items.GOLDEN_APPLE)).displayItems((itemDisplayParameters, output) -> {
            ...
            CreativeModeTabs.generateOminousVials(output, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        Registry.register(registry, SPAWN_EGGS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4).title(Component.translatable("itemGroup.spawnEggs")).icon(() -> new ItemStack(Items.PIG_SPAWN_EGG)).displayItems((itemDisplayParameters, output) -> {
    ...
    private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().map(reference -> EnchantedBookItem.createForEnchantment(new EnchantmentInstance((Holder<Enchantment>)reference, ((Enchantment)reference.value()).getMaxLevel()))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().flatMap(reference -> IntStream.rangeClosed(((Enchantment)reference.value()).getMinLevel(), ((Enchantment)reference.value()).getMaxLevel()).mapToObj(n -> EnchantedBookItem.createForEnchantment(new EnchantmentInstance((Holder<Enchantment>)reference, n)))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generatePresetPaintings(CreativeModeTab.Output output, HolderLookup.Provider provider, HolderLookup.RegistryLookup<PaintingVariant> registryLookup, Predicate<Holder<PaintingVariant>> predicate, CreativeModeTab.TabVisibility tabVisibility) {
        ...
        registryLookup.listElements().filter(predicate).sorted(PAINTING_COMPARATOR).forEach(reference -> {
            CustomData customData = ((CustomData)CustomData.EMPTY.update((DynamicOps<Tag>)registryOps, Painting.VARIANT_MAP_CODEC, reference).getOrThrow()).update(compoundTag -> compoundTag.putString("id", "minecraft:painting"));
