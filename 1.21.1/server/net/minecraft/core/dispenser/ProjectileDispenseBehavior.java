...
extends DefaultDispenseItemBehavior {
    ...
    public ItemStack execute(BlockSource blockSource, ItemStack itemStack) {
        ...
        Projectile projectile = this.projectileItem.asProjectile(serverLevel, position, itemStack, direction);
        this.projectileItem.shoot(projectile, direction.getStepX(), direction.getStepY(), direction.getStepZ(), this.dispenseConfig.power(), this.dispenseConfig.uncertainty());
