...
public class BuiltInRegistries {
    ...
    public static final Registry<FrogVariant> FROG_VARIANT = BuiltInRegistries.registerSimple(Registries.FROG_VARIANT, FrogVariant::bootstrap);
    ...
    public static final Registry<ArmorMaterial> ARMOR_MATERIAL = BuiltInRegistries.registerSimple(Registries.ARMOR_MATERIAL, ArmorMaterials::bootstrap);
    ...
    public static final Registry<ItemSubPredicate.Type<?>> ITEM_SUB_PREDICATE_TYPE = BuiltInRegistries.registerSimple(Registries.ITEM_SUB_PREDICATE_TYPE, ItemSubPredicates::bootstrap);
    ...
    private static <T, R extends WritableRegistry<T>> R internalRegister(ResourceKey<? extends Registry<T>> resourceKey, R r, RegistryBootstrap<T> registryBootstrap) {
        Bootstrap.checkBootstrapCalled(() -> "registry " + String.valueOf(resourceKey));
    ...
    private static <T extends Registry<?>> void validate(Registry<T> registry) {
        registry.forEach(registry2 -> {
            ...
            if (registry2 instanceof DefaultedRegistry) {
                ...
                Validate.notNull(registry2.get(resourceLocation), (String)("Missing default of DefaultedMappedRegistry: " + String.valueOf(resourceLocation)), (Object[])new Object[0]);
            }
        });
    }
